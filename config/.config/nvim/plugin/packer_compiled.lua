...
_G.packer_plugins = {
  ["Catppuccino.nvim"] = {
    loaded = true,
    path = "/Users/miguelaht/.local/share/nvim/site/pack/packer/start/Catppuccino.nvim"
  },
  ["cmp-buffer"] = {
    loaded = true,
  ...
  ["darcula-solid.nvim"] = {
    loaded = true,
    path = "/Users/miguelaht/.local/share/nvim/site/pack/packer/start/darcula-solid.nvim"
  },
  fzf = {
    loaded = false,
    needs_bufread = false,
  ...
  ["fzf-lua"] = {
    loaded = true,
    path = "/Users/miguelaht/.local/share/nvim/site/pack/packer/start/fzf-lua"
  },
  ["gruvbox-flat.nvim"] = {
    loaded = true,
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/Users/miguelaht/.local/share/nvim/site/pack/packer/start/lush.nvim"
  },
  ["nvim-cmp"] = {
    loaded = true,
  ...
  ["nvim-fzf"] = {
    loaded = true,
    path = "/Users/miguelaht/.local/share/nvim/site/pack/packer/start/nvim-fzf"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/miguelaht/.local/share/nvim/site/pack/packer/start/vim-vsnip"
  }
}
